    ...
    return (
        <div className={cn(
            ...
            <div className="p-2 flex gap-2 h-14 items-center mt-1">
                ...
                >
                    <Plus className={cn("w-4 h-4", loading ? "text-gray-400" : "text-gray-500")} /> New Workspace
                </button>
            ...
            <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <div className="px-2 pb-3 mt-auto">
                    <div className="text-xs uppercase tracking-[0.22em] text-slate-400 mb-2">Workspaces</div>
                    {navItems.map((item) => (
                        <button
                            key={item.id}
