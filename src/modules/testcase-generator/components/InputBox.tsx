            ...
            <div className="max-w-5xl mx-auto w-full flex flex-col gap-3">
                ...
                <AnimatePresence>
                    {showAdvanced && (
                        ...
                        >
                            <h3 className="text-[10px] uppercase font-bold text-gray-400 tracking-wider mb-1">Advanced Configuration</h3>
                ...
                <div className="flex justify-between items-center px-1 mb-1 flex-wrap gap-2">
                    <div className="flex gap-2 items-center flex-wrap">
                                ...
                                {isPlatformDropdownOpen && (
                                    ...
                                    >
                                        {(["web", "mobile", "api"] as const).map((p) => (
                                            <button key={p} onClick={() => { setPlatformType(p); setIsPlatformDropdownOpen(false); }}
                                                className={cn("w-full text-left px-3 py-2 text-sm rounded-md transition-colors",
                                                    p === platformType ? "bg-blue-500 text-white" : "text-gray-700 hover:bg-gray-100"
                                                )}>
                        ...
                        {/* Jira Story ID input */}
                        <div className="flex items-center gap-1.5 min-w-[160px] bg-white border border-gray-200 rounded-full px-3 py-1.5 shadow-sm">
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent border-none outline-none text-sm text-gray-700 placeholder:text-gray-400 font-mono w-32"
                            />
                        </div>
                ...
                <div className="relative flex items-end w-full bg-white rounded-xl border border-gray-300 shadow-[0_0_15px_rgba(0,0,0,0.05)] focus-within:shadow-[0_0_15px_rgba(0,0,0,0.1)] transition-shadow">
                    <textarea
                        ...
                        placeholder="Describe the feature to generate test cases..."
